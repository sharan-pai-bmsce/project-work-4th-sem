              ...
              <div class="" id="user-signin">
                ...
                <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>" class="text-left" style="margin: auto" id="user-form">
                  <div class="form-group">
                    ...
                    <input type="text" name="RID" id="RID" class="form-control" placeholder="Enter the reviwerer-id" value="" required pattern="[a-z A-Z 0-9]{10}" />
                    <label for="Name" class="ml-2">Name<span style="color: red; margin-left: 1mm;">*</span></label>
                    <input type="text" name="Name" id="Name" class="form-control" placeholder=" Enter the Name" value="" required pattern="[a-z A-Z]{2,}" />
                  </div>
                  <label for="registered_by" class="ml-2">Registered By<span style="color: red; margin-left: 1mm;">*</span></label>
                  <input type="text" name="registered_by" id="registered_by" class="form-control" placeholder="Enter the name of the registering person" value="" required pattern="[a-z A-Z]{2,}" />
                  <label for="publication_name name" class="ml-2">Publication name<span style="color: red; margin-left: 1mm;">*</span></label>
                  <input type="text" name="publication_name" id="publication_name" class="form-control" placeholder="Enter the publication name" value="" required pattern="[a-z A-Z]{2,}" />
                  <div class="form-group">
                    <label for="email" class="ml-2">E-mail<span style="color: red; margin-left: 1mm;">*</span></label>
                    <input type="email" name="email" id="email" class="form-control" placeholder="Enter the E-mail" required />
                  </div>
                  <div class="form-group mb-4">
                    <label for="password" class="ml-2">Password<span style="color: red; margin-left: 1mm;">*</span></label>
                    <input type="password" id="password" name="password" class="form-control" placeholder="Enter the new password" required minlength="8" maxlength="15" />
                  </div>
                  <div class="form-group mb-4">
                    <label for="password" class="ml-2">Password Verification<span style="color: red; margin-left: 1mm;">*</span></label>
                    <input type="password" id="password-confirm" class="form-control" placeholder="Re-enter the new password" required minlength="8" maxlength="15" />
                  </div>
                  <div class="text-center mt-3">
                    <input name="SUBMIT" id="SUBMIT" class="btn btn-dark mb-4" type="submit" value="REGISTER NOW" style="width:50%;" />
                  </div>
                </form>
              </div>
            </div>
